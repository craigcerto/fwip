...
class TestKimiAdapter:
    def test_k2_grounding(self, sample_extraction_system):
        result = refrase.adapt(sample_extraction_system, "kimi-k2")
...
class TestGLMAdapter:
    def test_enforces_english(self, sample_extraction_system):
        result = refrase.adapt(sample_extraction_system, "glm-4.7")
        assert "English" in result.system
    ...
    def test_flash_simplifies(self, sample_analysis_system):
        flash = refrase.adapt(sample_analysis_system, "glm-4.7-flash", task="analysis")
        full = refrase.adapt(sample_analysis_system, "glm-4.7", task="analysis")
